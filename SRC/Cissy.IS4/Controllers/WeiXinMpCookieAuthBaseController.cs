...
namespace Cissy.IS4
{
    public abstract class WeiXinMpCookieAuthBaseController : WeiXinMpAuthBaseController
    {
        public WeiXinMpCookieAuthBaseController(ICissyConfig cissyConfig) : base(cissyConfig)
        { }
        [HttpGet]
        public override IActionResult DoSignIn(string AuthenticationScheme, ClaimsPrincipal pricipal)
        {
            ...
            //HttpContext.Response.Cookies.Append(AuthenticationScheme, builder.BuildToken(pricipal.Claims), new Microsoft.AspNetCore.Http.CookieOptions() {
            //    HttpOnly = true
            //});
