...
namespace Cissy
{
    public abstract class BlazorWASMStartup
    {
        ...
        public BlazorWASMStartup(IConfiguration configuration, IWebHostEnvironment hostingEnvironment)
        {
            _configuration = configuration;
            _hostingEnvironment = hostingEnvironment;
        }
        public static void Start<T>(string[] args) where T : BlazorWASMStartup
        {
            var pg = new Cissy.BlazorWASMProgram<T>();
            pg.Start(args);
            _program = pg;
        }
