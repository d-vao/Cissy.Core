...
namespace Cissy.Html
{
    ...
    /// </summary>
    public class TemplateParser : ITemplateTagContainer
    {
        ...
        private Dictionary<string, TemplateTag> _templateTags = new Dictionary<string, TemplateTag>();
        public IEnumerable<TemplateTag> TemplateTags
        {
            get { return _templateTags.Values; }
        }
        #endregion
    }
}
