...
namespace Cissy.Serialization.Json
{
    ...
    public static class SerializerHelper
    {
        ...
        /// <returns></returns>
        public static string GetJsonString<T>(T data, JsonSetting jsonSetting = null) where T : IModel
        {
            return data.ModelToJson();
        }
        ...
        /// <returns></returns>
        public static T GetObject<T>(this string jsonString) where T : IModel
        {
            return jsonString.JsonToModel<T>();
