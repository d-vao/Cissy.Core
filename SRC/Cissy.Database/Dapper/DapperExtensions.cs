...
namespace Cissy.Dapper
{
    public static class DapperExtensions
    {
        ...
        private static Func<ICissyDapperConfiguration, IDapperImplementor> _instanceFactory;
        private static IDapperImplementor _instance;
        private static ICissyDapperConfiguration _configuration;

        /// <summary>
        /// Gets or sets the default class mapper to use when generating class maps. If not specified, AutoClassMapper<T> is used.
        /// Cissy.Dapper.Configure(Type, IList<Assembly>, ISqlDialect) can be used instead to set all values at once
        /// </summary>
        ...
        /// </summary>
        public static Func<ICissyDapperConfiguration, IDapperImplementor> InstanceFactory
        {
            get
            {
        ...
        {
            Configure(new CissyDapperConfiguration(defaultMapper, mappingAssemblies, sqlDialect));
        }

        /// <summary>
        /// Executes a query for the specified id, returning the data typed as per T
        /// </summary>
        public static T Get<T>(this DbConnection connection, dynamic id, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static void Insert<T>(this DbConnection connection, IEnumerable<T> entities, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static dynamic Insert<T>(this DbConnection connection, T entity, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static bool Update<T>(this DbConnection connection, T entity, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
            return Instance.Update<T>(connection, entity, transaction, commandTimeout);
        }
        public static bool LockUpdate<T>(this DbConnection connection, T entity, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IDataVersion
        {
            return Instance.LockUpdate<T>(connection, entity, transaction, commandTimeout);
        }
        /// <summary>
        /// Executes a delete query for the specified entity.
        /// </summary>
        public static bool Delete<T>(this DbConnection connection, T entity, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static bool Delete<T>(this DbConnection connection, object predicate, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static IEnumerable<T> GetList<T>(this DbConnection connection, object predicate = null, IList<ISort> sort = null, DbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static IEnumerable<T> GetPage<T>(this DbConnection connection, object predicate, IList<ISort> sort, int page, int resultsPerPage, DbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static IEnumerable<T> GetSet<T>(this DbConnection connection, object predicate, IList<ISort> sort, int firstResult, int maxResults, DbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static int Count<T>(this DbConnection connection, object predicate, DbTransaction transaction = null, int? commandTimeout = null) where T : Cissy.Database.IEntity
        {
        ...
        /// </summary>
        public static IClassMapper GetMap<T>() where T : Cissy.Database.IEntity
        {
